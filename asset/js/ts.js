...
TS = {
    ...
    ,cycle_proxy : function(e){
        ...
        TS.change_proxy(TS.config.current_proxy_index+1);
        TS.config.current_proxy_index = (TS.config.current_proxy_index+1)%TS.config.proxy_list.length;
        TS.save_config();
    }
    ,load_config : function(){
        var default_config = {
            ...
            ,'use_default_proxy':0
            ,'proxy_list':[
                //{ mode:'direct', is_default:0 }
                //,{ mode:'pac_script',is_default:1, pac_script_url:'file:///Users/oylbin/oylbin/proxy.pac' }
                //,{ mode:'fixed_servers',is_default:0, fixed_servers_schema:'socks5', fixed_servers_name:'127.0.0.1', fixed_servers_port:'8527' }
            ]
            ,'current_proxy_index':0
        };
        try{
            var config = JSON.parse(localStorage['tunnel_switch_config']);
    ...
    ,save_config : function(){
        localStorage['tunnel_switch_config'] = JSON.stringify(TS.config);
